...
import { ArrowRight, BrainCircuit, Link, ShieldCheck, User } from "lucide-react";

export function Aboutdash() {
  const teamMembers = [
    {
      name: "Sarah Chen",
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="hidden md:flex items-center gap-6 text-sm font-medium text-neutral-800">
          ...
          <Link to="/profile" className="w-10 h-10 rounded-full bg-white border border-[#dcf0ff] shadow-sm flex items-center justify-center text-indigo-600 overflow-hidden hover:scale-105 transition-transform">
